...
def main():
    ...
    transaction = pd.merge(transaction, aer, on='TransactionID', how='left')
    ...
    feature = [f for f in transaction_new.columns if f!='TransactionID' and f!='split']
    ...
    train_x = train[transaction]
    test_x = test[transaction]
    ...
    valid[['TransactionID', 'isFraud']].to_csv('submit1.csv', index=False)
